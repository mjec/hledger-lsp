...
export function validateMissingAmounts(transaction: Transaction, document: TextDocument): Diagnostic[] {
...
export function validatePeriodicTransactionMissingAmounts(periodicTx: PeriodicTransaction, document: TextDocument): Diagnostic[] {
    const diagnostics: Diagnostic[] = [];
